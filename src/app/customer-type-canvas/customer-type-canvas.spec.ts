...
describe("CustomerTypeCanvasComponent", () => {
  ...
  let fixture: ComponentFixture<CustomerTypeCanvasComponent>;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(CustomerTypeCanvasComponent);
    component = fixture.componentInstance;
    fixture.detectChanges();
  });

  it("Customer Type Canvas component should be created", () => {
